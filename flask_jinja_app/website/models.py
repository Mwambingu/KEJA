...
class Landlord(BaseModel, db.Model):
    ...
    tenants = db.relationship("Tenant", backref="landlords", cascade="all, delete", lazy=True,)
    houses = db.relationship("House", backref="landlords", cascade="all, delete", lazy=True)
...
class House(BaseModel, db.Model):
    ...
    apartments = db.relationship("Apartment", backref="houses", cascade="all, delete", lazy=True)
...
class Apartment(BaseModel, db.Model):
    ...
    apt_tenant = db.relationship("Tenant", backref="apartments", cascade="all, delete", lazy=True)
